...
GO
CREATE NONCLUSTERED INDEX [IDX_LMoves_Evals] ON [lake].[Moves]([T1_Eval_POV] ASC, [T2_Eval_POV] ASC, [T3_Eval_POV] ASC, [T4_Eval_POV] ASC, [T5_Eval_POV] ASC);
...
GO
CREATE NONCLUSTERED INDEX [IDX_LMoves_MoveScored] ON [lake].[Moves]([MoveScored] ASC) INCLUDE([Move_Rank], [CP_Loss], [ScACPL]);
