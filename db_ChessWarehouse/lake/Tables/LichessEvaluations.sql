...
GO
CREATE NONCLUSTERED INDEX [IDX_LEvals_ColorID] ON [lake].[LichessEvaluations]([ColorID] ASC);

GO
CREATE NONCLUSTERED INDEX [IDX_LEvals_FEN] ON [lake].[LichessEvaluations]([FEN] ASC);
