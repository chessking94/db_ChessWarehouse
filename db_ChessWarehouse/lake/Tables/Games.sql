...
GO
CREATE NONCLUSTERED INDEX [IDX_LGames_BlackPlayerID] ON [lake].[Games]([BlackPlayerID] ASC);

GO
CREATE NONCLUSTERED INDEX [IDX_LGames_WhitePlayerID] ON [lake].[Games]([WhitePlayerID] ASC);

GO
CREATE NONCLUSTERED INDEX [IDX_LGames_EventID] ON [lake].[Games]([EventID] ASC);

GO
CREATE NONCLUSTERED INDEX [IDX_LGames_SourceID] ON [lake].[Games]([SourceID] ASC);

GO
CREATE NONCLUSTERED INDEX [IDX_LGames_TimeControlDetailID] ON [lake].[Games]([TimeControlDetailID] ASC);
