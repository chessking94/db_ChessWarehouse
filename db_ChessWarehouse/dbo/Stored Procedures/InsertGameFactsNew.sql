...
LEFT JOIN fact.Game fg ON
	g.SourceID = fg.SourceID
	AND g.GameID = fg.GameID
	AND m.ColorID = fg.ColorID
...
--	g.SourceID = fgs.SourceID
--	AND g.GameID = fgs.GameID
--	AND m.ColorID = fgs.ColorID
--	AND ms.ScoreID = fgs.ScoreID
