CREATE TABLE [fact].[EvaluationSplits] (
	...
	,CONSTRAINT [PK_EvaluationSplits] PRIMARY KEY CLUSTERED ([SourceID] ASC, [TimeControlID] ASC, [EvaluationGroupID_T1] ASC, [EvaluationGroupID_T2] ASC, [EvaluationGroupID_T3] ASC, [EvaluationGroupID_T4] ASC, [EvaluationGroupID_T5] ASC)
