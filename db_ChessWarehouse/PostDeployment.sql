...
(
    VALUES
        ...
        (4, 'ContextualMoveQuality', 'Marries together the win probability lost by similar top move distributions based on game source and time control', 1)
...
(
    VALUES
        (1, 'Personal', 1, 15, 1, 1, 10),
        (2, 'PersonalOnline', 1, 11, 1, 1, 10),
        (3, 'Control', 0, 11, 1, 1, 10),
